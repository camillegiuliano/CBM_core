...
Once complete, outputs of the spinup are saved to the simlist. 
...
**Camille: since I don't think the links to the `.csv` files will work, maybe we should insert the decay_parameters.csv here as a table**
